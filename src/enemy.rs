...
use crate::{camera::MainCamera, util::polar_to_cartesian, player::Player, pursue::pursue};
...
fn move_enemy(
    ...
    let velocity = pursue(transform.translation.truncate(), player_transform.translation.truncate(), Enemy::VELOCITY) * time.delta_seconds();
